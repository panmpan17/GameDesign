...
namespace MPack
{
    ...
    public class LayerMaskReferenceDrawer : RereferenceDrawer
    {
        ...
        {
            string path = EditorUtility.SaveFilePanelInProject("New Layer Mask Variable", "New LayerMask.asset", "asset", "Test");
